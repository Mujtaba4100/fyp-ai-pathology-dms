...
class MSSQLService:
    ...
    def get_connection(self):
        ...
        try:
            ...
            encrypt_params = (
                ";TrustServerCertificate=yes" if "Driver 18" in driver else ""
            )
            ...
            raise Exception(
                f"MS SQL Connection failed using driver '{driver}': {str(e)}"
            )
    ...
    def save_document(
        ...
        try:
            ...
            cursor.setinputsizes(
                [None, None, None, (pyodbc.SQL_VARBINARY, len(file_data)), None]
            )
            cursor.execute(
                insert_query,
                (
